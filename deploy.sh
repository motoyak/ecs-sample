...
AWS_ECS_TASKDEF_NAME=ecs-circle-test
AWS_ECS_CLUSTER_NAME=sample-cluster
AWS_ECS_SERVICE_NAME=sample-service
AWS_ECR_REP_NAME=ecs-circle-test
...
push_ecr_image(){
	...
	docker push $AWS_ACCOUNT_ID.dkr.ecr.ap-northus-east-1.amazonaws.com/${AWS_ECR_REP_NAME}:$CIRCLE_SHA1
}
